...
public class HangmanGame 
{
	...
	private static final String WORD_LIST_PATH = "/org/wargamesproject/hangman/lesson4/wordList.txt";
	// Hangman representation in ACSII
	private static String[] HANGMAN_PICTURE0 = {"---+ ","|  ! ","|  o ","| \\|/","|  | ","| / \\","|    ","#####"};
	private static String[] HANGMAN_PICTURE1 = {"---+ ","|  ! ","|  o ","| \\|/","|  | ","| /  ","|    ","#####"};
	private static String[] HANGMAN_PICTURE2 = {"---+ ","|  ! ","|  o ","| \\|/","|  | ","|    ","|    ","#####"};
	private static String[] HANGMAN_PICTURE3 = {"---+ ","|  ! ","|  o ","| \\|/","|    ","|    ","|    ","#####"};
	private static String[] HANGMAN_PICTURE4 = {"---+ ","|  ! ","|  o ","| \\| ","|    ","|    ","|    ","#####"};
	private static String[] HANGMAN_PICTURE5 = {"---+ ","|  ! ","|  o ","|  | ","|    ","|    ","|    ","#####"};
	private static String[] HANGMAN_PICTURE6 = {"---+ ","|  ! ","|  o ","|    ","|    ","|    ","|    ","#####"};
	private static String[] HANGMAN_PICTURE7 = {"---+ ","|  ! ","|    ","|    ","|    ","|    ","|    ","#####"};
	private static String[] HANGMAN_PICTURE8 = {"---+ ","|    ","|    ","|    ","|    ","|    ","|    ","#####"};
	private static String[] HANGMAN_PICTURE9 = {"     ","     ","     ","     ","     ","     ","     ","#####"};
	private static String[] HANGMAN_PICTURE10 = {"     ","     ","     ","      ","     ","     ","     ","     "};
	
	private static String[][] HANGMANS = {HANGMAN_PICTURE0,HANGMAN_PICTURE1,HANGMAN_PICTURE2,HANGMAN_PICTURE3,HANGMAN_PICTURE4,HANGMAN_PICTURE5,HANGMAN_PICTURE6,HANGMAN_PICTURE7,HANGMAN_PICTURE8,HANGMAN_PICTURE9,HANGMAN_PICTURE10};
		...
		if (this.wordList.size() > 0)
		{
			...
			while (gameState.isGameOver() == false)
			{
				...
				try
				{
					...
					this.showHangman(gameState.getGuessesRemaining());
				}
	...
	private void showHangman(int guessesRemaining)
	{
		System.out.println("guessesRemaining = " + guessesRemaining);
		
		for (String hangmanLine : HANGMANS[guessesRemaining])
		{
			System.out.println(hangmanLine);
		}
	}
